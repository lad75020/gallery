<?php
    ...
    define("__DOMAIN__", "raspberrypi.dubertrand.corp");
    define("__ROOT_URL__", __PROTOCOL__."://".__DOMAIN__."/");
    define("__VIDEOS_FOLDER__","videos");
    define("__SMALL_PIX_FOLDER__","XXX");
    define("__ORIGINAL_PIX_FOLDER__","XXX");
    define("__UPLOADS_FOLDER__", "uploads");
    define("__FOLDERS_ROOT__", "/var/www/");
